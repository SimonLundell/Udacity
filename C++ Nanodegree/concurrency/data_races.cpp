...
// A data race can occur when 2 threads access the same memory location, 1 thread writing data and the second thread reading. 
// Below is safe way of executing it
class Vehicle
{
public:
    //default constructor
