...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic; // make unique
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); } // added .get() which fetches the pointed to object of a smart-pointer
